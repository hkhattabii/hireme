...
class RecruiterRegistrationView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("RECRUITER", style: TextStyle(color: Colors.white),),
          leading: IconButton(
...
uploadImage(BuildContext context, File image) {
  BlocProvider.of<RegistrationBloc>(context).add(CandidateAddImage(image: image));
}
